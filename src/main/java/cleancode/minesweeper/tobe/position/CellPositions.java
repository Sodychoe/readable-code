...
public class CellPositions {
  ...
  public List<CellPosition> subtract(List<CellPosition> cellPositionListToSubtract) {
    ArrayList<CellPosition> cellPositions = new ArrayList<>(positions);

    CellPositions positionsToSubtract = CellPositions.of(cellPositionListToSubtract);
